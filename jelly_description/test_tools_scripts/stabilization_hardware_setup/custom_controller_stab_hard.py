...
class AttitudeController():
    def __init__(self):
        ...
        self.pose_subscriber = rospy.Subscriber("/rov/depth_odom", Odometry, self.input_real_pose)
        self.main_quaternion_subscriber = rospy.Subscriber("/jelly/main/orientation",Imu,self.input_main_quaternion_orientation)
        self.quaternion_subscriber = rospy.Subscriber('/data', Imu, self.input_quaternion_orientation)
