...
class stabMain():
    ...
    def check_time(self):
        ...
        while not rospy.is_shutdown():
            ...
            elif (rospy.get_time() - self.start_time) >= 10:
                if self.flag.data == 0:
                    ...
                    controller_node = roslaunch.core.Node(package=pkg,node_type='custom_controller_stab_hard.py',name=node_control,output='screen')
