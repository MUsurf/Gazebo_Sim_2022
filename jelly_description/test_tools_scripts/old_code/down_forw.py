...
class MainLoop():
    ...
    def callback(self,message_rec):
        ...
        self.motor5.duty_cycle = self.microSec_to_duty(message_rec[3],pca.frequency)
        self.motor6.duty_cycle = self.microSec_to_duty(message_rec[4],pca.frequency)
        self.motor7.duty_cycle = self.microSec_to_duty(message_rec[5],pca.frequency)
        self.motor8.duty_cycle = self.microSec_to_duty(message_rec[6],pca.frequency)
...
print("Diving: ")
loop.callback([front_motors,down_motors,down_motors,1550,down_motors,down_motors,front_motors])
